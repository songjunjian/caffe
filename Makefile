...
$(MAT$(PROJECT)_SO): $(MAT$(PROJECT)_SRC) $(STATIC_NAME)
	...
	@ echo MEX $<
	$(Q)$(MATLAB_DIR)/bin/mex -g $(MAT$(PROJECT)_SRC) \
			CXX="$(CXX)" \
			CXXFLAGS="\$$CXXFLAGS $(MATLAB_CXXFLAGS)" \
			INCLUDE="\$$INCLUDE $(MATLAB_INCLUDE)" \
			CXXLIBS="\$$CXXLIBS $(STATIC_LINK_COMMAND) $(LDFLAGS) $(MATLAB_LIBS)" \
			-output $@
	echo "mex $(MAT$(PROJECT)_SRC) CXX=$(CXX) CXXFLAGS=$(CXXFLAGS) $(MATLAB_CXXFLAGS)" 
	echo "		INCLUDE=$(INCLUDE) $(MATLAB_INCLUDE) "
	echo "		CXXLIBS=$(CXXLIBS) $(STATIC_LINK_COMMAND) $(LDFLAGS) $(MATLAB_LIBS)" 
	echo "		-output $@ "
